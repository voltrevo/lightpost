...
exports.interpreter = function()
{
    ...
    this.symbols =
    {
        ...
        {
            argc: 0,
            exec: function() { console.log(self.exec_layer.stack); }
        },
        'exec':
        {
            argc: 1,
            exec: function(fn) { self.exec_layer.exec(fn); }
        }
    };
    ...
    this.exec_layer = new (function()
    {
        ...
        this.handle_word = function(word)
        {
            if (word[word.length - 1] === '#')
            {
                ...
                if (self.symbols[sub_word])
                {
                    layer.stack.push(self.symbols[sub_word]);
                }
                else
                {
            ...
            else if (self.symbols[word])
            {
                layer.exec(self.symbols[word]);
            }
        ...
        this.exec = function(fn)
        {
            ...
            var ret = fn.exec.apply(null, layer.stack.splice(layer.stack.length - fn.argc, fn.argc));
